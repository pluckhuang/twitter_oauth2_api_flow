...
class Client:
    ...
    def get_token(self, code, code_verifier):
        ...
        # token = 'WlVWQmFGQk5UVTVyTFdRMFFUVkVaVmR5TkhBNk1UcGphUTo1aUpNNGlYYWpSNWpCVlAyRGZzYnN0SEtQNGw4ei1fYkJ1SG9Mc0luS3N2S2VxY2l4UQ=='
        # try:
        #     token_response = self.__urlopen(self.config['token_endpoint'], urlencode(data), context=self.ctx)
        ...
        # return json.loads(token_response.read())
        import json
        print('url: ' + self.config['token_endpoint'])
